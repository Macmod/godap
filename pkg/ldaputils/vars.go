...
var PredefinedLdapQueriesAD = map[string][]LibQuery{
	...
	"Group Members": {
		...
		{"Administrators", "(memberOf=CN=Administrators,CN=Builtin,DC=domain,DC=com)"},
		...
		{"DNS Admins", "(memberOf=CN=DnsAdmins,CN=Users,DC=domain,DC=com)"},
		...
		{"Account Operators", "(memberOf=CN=Account Operators,CN=Builtin,DC=domain,DC=com)"},
		{"WinRMRemoteWMIUsers__", "(memberOf=CN=WinRMRemoteWMIUsers__,CN=Users,DC=domain,DC=com)"},
		{"Group Policy Creator Owners", "(memberOf=CN=Group Policy Creator Owners,CN=Users,DC=domain,DC=com)"},
		{"Remote Desktop Users", "(memberOf=CN=Remote Desktop Users,CN=Builtin,DC=domain,DC=com)"},
		{"Remote Management Users", "(memberOf=CN=Remote Management Users,CN=Builtin,DC=domain,DC=com)"},
		{"Print Operators", "(memberOf=CN=Print Operators,CN=Builtin,DC=domain,DC=com)"},
		{"DHCP Administrators", "(memberOf=CN=DHCP Administrators,CN=Users,DC=domain,DC=com)"},
		{"Hyper-V Administrators", "(memberOf=CN=Hyper-V Administrators,CN=Builtin,DC=domain,DC=com)"},
		{"Cert Publishers", "(memberOf=CN=Cert Publishers,CN=Users,DC=domain,DC=com)"},
		{"Protected Users", "(memberOf=CN=Protected Users,CN=Users,DC=domain,DC=com)"},
	},
}
